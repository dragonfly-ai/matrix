...
object SV extends Verification {
  ...
  override def run: Unit = {
    ...
    val msvd:matrix.decomposition.SV = matrix.decomposition.SV(mm)
    ...
    println(s"\tComparing Singular Values: ${Verification.arrayCompare(jsvd.getSingularValues, msvd.getSingularValues())}")
